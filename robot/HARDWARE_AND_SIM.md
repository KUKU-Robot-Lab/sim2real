...
> 평소 운영은 **운영 콘솔 한 화면**에서 한다 → [README](../README.md).
> 이 문서는 콘솔이 부르는 하드웨어 스택의 원리, 콘솔 없이 배선을 손으로 확인할 때, 그리고 Isaac Sim 브리지·
> 드라이브 튜닝을 다룬다. (2026-09-22 까지 README 본문이던 내용을 그대로 옮겼다.)
