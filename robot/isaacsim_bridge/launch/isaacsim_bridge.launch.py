...
def generate_launch_description():
    # 소스 트리에서 경로로 부를 때: robot/isaacsim_bridge/launch/ → robot/ → 형제 패키지 integrated_control.
    # (9c59f12 에서 sim/ 으로 옮긴 뒤 이 값이 sim/integrated_control 을 가리켜 with_hardware:=true 가 깨져 있었다.)
