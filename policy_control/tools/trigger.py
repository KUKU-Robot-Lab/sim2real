...
이 도구는 `episode_ctl.parse_trigger` 와 같은 규칙({"ok","reasons"} JSON)으로 읽는다.
    ...
    python3 policy_control/tools/trigger.py pd/engage                              # 계획만
    python3 policy_control/tools/trigger.py pd/goto_home --expect-pd TRACKING --execute
    python3 policy_control/tools/trigger.py episode/stop --execute
