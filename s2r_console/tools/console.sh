...
#
#   s2r_console/tools/console.sh                                  # 프로파일을 화면에서 고른다
#   s2r_console/tools/console.sh --profile pour_i18_fake --operator me
#   s2r_console/tools/console.sh --port 8092
#
...
cd "$SIM2REAL"
export PYTHONPATH="$SIM2REAL/s2r_console${PYTHONPATH:+:$PYTHONPATH}"
