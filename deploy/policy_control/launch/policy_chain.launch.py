...
인자
  ...
  use_source   true 면 colcon 설치 없이 venv python 으로 deploy/policy_control/policy_control/<node>.py 를 띄운다
...
PKG_ROOT = Path(__file__).resolve().parents[1]           # sim2real/deploy/policy_control
SIM2REAL = PKG_ROOT.parents[1]                          # deploy/policy_control → sim2real
