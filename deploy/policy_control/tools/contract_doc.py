...
"""deploy_contract.json → 사람이 읽는 계약 문서(markdown). 문서는 생성물이지 원본이 아니다.
    ...
    python3 deploy/policy_control/tools/contract_doc.py logs/policy/left_v2B25/deploy_contract.json \
...
def main(argv=None) -> int:
    ...
    cmd = "python3 deploy/policy_control/tools/contract_doc.py \\\n    " + " \\\n    ".join(
