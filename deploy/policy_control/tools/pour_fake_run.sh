...
bg ros2 launch deploy/policy_control/launch/fake_plant.launch.py side:=both robot:="$ROBOT" \
...
bg python deploy/policy_control/policy_control/pour_guard_node.py --ros-args \
