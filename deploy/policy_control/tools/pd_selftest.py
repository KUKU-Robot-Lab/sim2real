...
/joint_states 로 sign/ratio/crosstalk 표를 만든다(lowlevel_check_core 재사용). 결과 JSON.
    ...
    python3 deploy/policy_control/tools/pd_selftest.py --contract logs/policy/left_v2B25/deploy_contract.json \
        --robot deploy/policy_control/config/robots/left_gripper_real.yaml --execute --out logs/measure/pd_selftest.json
